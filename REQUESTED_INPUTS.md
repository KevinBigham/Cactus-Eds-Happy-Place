...
These are the exact missing inputs needed for the next safe gameplay pass.
...
- `If the World 2 left-turn camera snap still appears, record one literal repro path`
  - Why it matters: this is still unproven and should not be patched without a repeatable repro.
  - Needed detail: where Ed was, which direction was held, whether the issue happened once or repeatedly, and whether it happened in normal play or only in the certification checkpoint.
