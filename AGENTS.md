...
Root should only contain: `00_HANDOFF_FROM_CLAUDE_CODE.md`, `README_Instructions on What To Do.md`, `AGENTS.md`, `ACTIVE/`, `ARCHIVE/`, and config dirs (`.codex/`, `.Codex/`, `.github/`, `.gitignore`). Do not add files to root.
...
## Update AGENTS.md when durable instructions change
...
This project uses 4 AI agents with defined roles: Architect (ChatGPT 5.4 Pro), Builder (Codex 5.4), Reviewer (Codex Sonnet 4.6), Operations (Codex Cowork Opus 4.6). The `TASK_OWNER_ROLE` field in NEXT_TASK.md is the sole activation key. If your role doesn't match, propose only.
