...
Asset key: `cehp_art:ui:receipt_frame:thermal:01`
Manifest path: `assets/art/ui/receipt_frame_thermal_01.png`
Target dimensions: `768x1024`
Transparent background: `yes`
Manifest order: `32/37`

## Image Generation Prompt

Create one production PNG for Cactus Ed's Happiest Place at exactly 768x1024. Use DKC-inspired pre-rendered chunkiness applied to CEHP bureaucratic horror: toy-like silhouettes, hard overhead fluorescent lighting, heavy ambient-occlusion reads, manila paper surfaces, cold cyan spill, bureau navy shadows, and blood-orange warning accents.

Receipt UI ornament plate for receipt frame in the thermal style, decorative but leaving gameplay text legible.
...
When exporting, overwrite only `ACTIVE/game/assets/art/ui/receipt_frame_thermal_01.png` and then run `node ACTIVE/game/scripts/validate_art_manifest.mjs`.
