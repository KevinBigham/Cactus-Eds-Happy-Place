...
Asset key: `cehp_art:ui:receipt_frame:normal:01`
Manifest path: `assets/art/ui/receipt_frame_normal_01.png`
Target dimensions: `768x1024`
Transparent background: `yes`
Manifest order: `33/37`
...
Receipt UI ornament plate for receipt frame in the normal style, decorative but leaving gameplay text legible.
...
When exporting, overwrite only `ACTIVE/game/assets/art/ui/receipt_frame_normal_01.png` and then run `node ACTIVE/game/scripts/validate_art_manifest.mjs`.
