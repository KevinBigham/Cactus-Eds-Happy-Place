...
Asset key: `cehp_art:bosses:logistics_foreman:telegraph:01`
Manifest path: `assets/art/bosses/logistics_foreman_telegraph_01.png`
Target dimensions: `1024x1024`
Transparent background: `yes`
Manifest order: `14/37`
...
Mini-boss logistics foreman in the telegraph state, posed for a platformer encounter with a clear center-weighted silhouette.
...
When exporting, overwrite only `ACTIVE/game/assets/art/bosses/logistics_foreman_telegraph_01.png` and then run `node ACTIVE/game/scripts/validate_art_manifest.mjs`.
