...
Asset key: `cehp_art:bosses:supervisor:defeated:01`
Manifest path: `assets/art/bosses/supervisor_defeated_01.png`
Target dimensions: `1024x1024`
Transparent background: `yes`
Manifest order: `09/37`
...
Mini-boss supervisor in the defeated state, posed for a platformer encounter with a clear center-weighted silhouette.
...
When exporting, overwrite only `ACTIVE/game/assets/art/bosses/supervisor_defeated_01.png` and then run `node ACTIVE/game/scripts/validate_art_manifest.mjs`.
