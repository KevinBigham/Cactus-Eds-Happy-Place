...
Asset key: `cehp_art:bosses:logistics_foreman:idle:01`
Manifest path: `assets/art/bosses/logistics_foreman_idle_01.png`
Target dimensions: `1024x1024`
Transparent background: `yes`
Manifest order: `13/37`
...
Mini-boss logistics foreman in the idle state, posed for a platformer encounter with a clear center-weighted silhouette.
...
When exporting, overwrite only `ACTIVE/game/assets/art/bosses/logistics_foreman_idle_01.png` and then run `node ACTIVE/game/scripts/validate_art_manifest.mjs`.
