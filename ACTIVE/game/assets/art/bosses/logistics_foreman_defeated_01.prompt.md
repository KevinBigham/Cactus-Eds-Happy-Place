...
Asset key: `cehp_art:bosses:logistics_foreman:defeated:01`
Manifest path: `assets/art/bosses/logistics_foreman_defeated_01.png`
Target dimensions: `1024x1024`
Transparent background: `yes`
Manifest order: `15/37`
...
Mini-boss logistics foreman in the defeated state, posed for a platformer encounter with a clear center-weighted silhouette.
...
When exporting, overwrite only `ACTIVE/game/assets/art/bosses/logistics_foreman_defeated_01.png` and then run `node ACTIVE/game/scripts/validate_art_manifest.mjs`.
