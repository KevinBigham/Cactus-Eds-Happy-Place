...
Asset key: `cehp_art:bosses:enrollment_officer:idle:01`
Manifest path: `assets/art/bosses/enrollment_officer_idle_01.png`
Target dimensions: `1024x1024`
Transparent background: `yes`
Manifest order: `10/37`
...
Mini-boss enrollment officer in the idle state, posed for a platformer encounter with a clear center-weighted silhouette.
...
When exporting, overwrite only `ACTIVE/game/assets/art/bosses/enrollment_officer_idle_01.png` and then run `node ACTIVE/game/scripts/validate_art_manifest.mjs`.
