...
Asset key: `cehp_art:characters:cactus_ed:jump_apex:01`
Manifest path: `assets/art/characters/cactus_ed_jump_apex_01.png`
Target dimensions: `1024x1024`
Transparent background: `yes`
Manifest order: `03/37`
...
Cactus Ed, the small cactus employee hero, shown in the jump apex gameplay pose with readable silhouette and no extra characters.
...
When exporting, overwrite only `ACTIVE/game/assets/art/characters/cactus_ed_jump_apex_01.png` and then run `node ACTIVE/game/scripts/validate_art_manifest.mjs`.
