...
Asset key: `cehp_art:environments:rasta:far:01`
Manifest path: `assets/art/environments/rasta_far_01.png`
Target dimensions: `1024x576`
Transparent background: `yes`
Manifest order: `29/37`
...
Parallax far layer for the rasta world, horizontally tile-friendly and clean behind gameplay actors.
...
When exporting, overwrite only `ACTIVE/game/assets/art/environments/rasta_far_01.png` and then run `node ACTIVE/game/scripts/validate_art_manifest.mjs`.
