...
Asset key: `cehp_art:environments:benefits:mid:01`
Manifest path: `assets/art/environments/benefits_mid_01.png`
Target dimensions: `1024x576`
Transparent background: `yes`
Manifest order: `27/37`
...
Parallax mid layer for the benefits world, horizontally tile-friendly and clean behind gameplay actors.
...
When exporting, overwrite only `ACTIVE/game/assets/art/environments/benefits_mid_01.png` and then run `node ACTIVE/game/scripts/validate_art_manifest.mjs`.
