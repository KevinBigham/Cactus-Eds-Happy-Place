...
Asset key: `cehp_art:setpieces:trust_fall:hero:01`
Manifest path: `assets/art/setpieces/trust_fall_01.png`
Target dimensions: `1024x1024`
Transparent background: `no`
Manifest order: `20/37`
...
Setpiece backdrop for trust fall, staged as a bureaucratic platformer scene with strong depth and no UI text.
...
When exporting, overwrite only `ACTIVE/game/assets/art/setpieces/trust_fall_01.png` and then run `node ACTIVE/game/scripts/validate_art_manifest.mjs`.
