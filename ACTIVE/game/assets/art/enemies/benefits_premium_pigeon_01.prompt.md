...
Asset key: `cehp_art:enemies:benefits_premium_pigeon:idle:01`
Manifest path: `assets/art/enemies/benefits_premium_pigeon_01.png`
Target dimensions: `1024x1024`
Transparent background: `yes`
Manifest order: `19/37`
...
Enemy plate for benefits premium pigeon in the idle state, readable at small in-game scale and separated from the background.
...
When exporting, overwrite only `ACTIVE/game/assets/art/enemies/benefits_premium_pigeon_01.png` and then run `node ACTIVE/game/scripts/validate_art_manifest.mjs`.
