...
Asset key: `cehp_art:enemies:orientation_clipboard_imp:idle:01`
Manifest path: `assets/art/enemies/orientation_clipboard_imp_01.png`
Target dimensions: `1024x1024`
Transparent background: `yes`
Manifest order: `18/37`
...
Enemy plate for orientation clipboard imp in the idle state, readable at small in-game scale and separated from the background.
...
When exporting, overwrite only `ACTIVE/game/assets/art/enemies/orientation_clipboard_imp_01.png` and then run `node ACTIVE/game/scripts/validate_art_manifest.mjs`.
