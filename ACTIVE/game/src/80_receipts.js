...
(function(ns){
  ...
  function scoreFragment(fragment, axes, tensions, context){
    if (!allFlagsMatch(fragment, context)) return -9999;
  ...
  registerFragment('VERDICTS', 'W12_RASTA_VERDICT_DARK_01', 'THE CIGARETTE STAYED OFF DUTY.', {worlds:{rasta:3.5}, flags:{cigaretteLit:false}, axes:{intuition:0.4, grace:0.3}, tone:'benign'});
  registerFragment('TENSIONS', 'W12_RASTA_TENSION_DARK_01', 'NO FIRE IMPROVED THE ROUTE.', {worlds:{rasta:3.5}, flags:{cigaretteLit:false}, tensions:{auditRisk:-0.4}, axes:{intuition:0.3}, tone:'benign'});
