...
var EXPECTED_ASSETS = [
  ...
  { file: 'cactus_ed_in_game_sprite.png',           role: 'in_game_sprite_candidate (HELD — Kevin taste-gate)' },
  { file: 'ed_sheet_60px.png',                      role: 'W10 Phase 6 Ed runtime sheet (48x64x30 frames)', minBytes: 1, maxBytes: 12288 },
  { file: 'cactus_ed_portraits_unmasked.png',       role: '6-face unmasked human portrait grid' },
  ...
  { file: 'stamps_sheet.png',                       role: 'APPROVED/DENIED/REJECTED/FILED stamp grid' },
  { file: 'title_cold_open.png',                    role: 'BootScene splash fallback (wired 2026-04-22)' },
  { file: 'ui_clipboard.png',                       role: 'diegetic pause-UI surface' },
  { file: 'ui_locker.png',                          role: 'diegetic save-UI surface (sticker copy corrected 2026-04-23)' },
  { file: 'ui_training_poster.png',                 role: 'diegetic controls-UI surface' },
  // --- BATCH 2 TIER 1 MUST (2026-04-22 Codex v2 — high-leverage thesis/environment) ---
  { file: 'cactus_ed_portraits_masked.png',         role: 'masked 6-face grid — pairs with unmasked (unwired — asset available)' },
  ...
  { file: 'paper_hr_memo.png',                      role: 'diegetic HR memo (correct as-is per Kevin; no regen)' },
